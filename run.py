...
from app.handlers.product_handler import add_product_handler, list_products_handler, delete_product_handler, get_product_handler
...
def get_product(product_id):
    return get_product_handler(product_service, product_id)
